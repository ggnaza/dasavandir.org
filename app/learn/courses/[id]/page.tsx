  ...
  return (
    ...
    <div className="max-w-2xl">
      ...
      <div className="mb-6 flex flex-wrap gap-2">
        ...
        {/* Schedule/timetable link hidden pending timetable rework (ADR-0003) — phased
            groups break resolved_timetable()'s single-group resolution. Restore this
            block (gated on course.timetable_enabled) when the rework lands. */}
        {capstone && (
          <Link
