...
import { POINT_DISTRIBUTION, COGNITIVE_LEVELS } from "@/lib/ararka/constants";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/ararka" className="text-gray-500 hover:text-gray-700">
          &larr; Tests
        </Link>
      </div>
